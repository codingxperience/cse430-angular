...
export const MOCKCONTACTS: Contact[] = [
  ...
  // index 13
  {
    id: '4', name: 'Network/OS team', email: 'armstrongb@byui.edu', phone: '208-496-3766', imageUrl: '../../assets/images/armstrongb.jpg', group: [
    {
      id: '2',
      name: 'Bradley Armstrong',
      email: 'armstrongb@byui.edu',
  ...
  // index 14
  {
    id: '6', name: 'Software Development team', email: 'barzeer@byui.edu ', phone: ' 208-496-3768', imageUrl: ' ../../assets/images/barzeer.jpg', group: [
    {
      id: '1',
      name: 'Rex Barzee',
      email: 'barzeer@byui.edu',
